...
function addMessage(text, sender, options = {}) {
    ...
    avatar.textContent = sender === 'user' ? '' : 'CH';
...
function resetConversation() {
    ...
    fetch('/reset', {
        ...
        .then(data => {
            // Clear chat messages
            chatMessages.innerHTML = '<div class="welcome-message" role="status"><span class="agent-mark" aria-hidden="true">CH</span><div><strong>Computing History Agent</strong> is ready to help with pioneers, machines, programming languages, operating systems, and the stories behind modern computing.</div></div>';
            messageInput.focus();
